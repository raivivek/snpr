namespace :curated_phenotypes do
  ...
  task :create => :environment do
    ...
    make_phenotype("SAT without writing test", "", false, ["600", "1600", "30"])
    make_phenotype("SAT with writing test", "", false, ["900", "2400", "50"])
    make_phenotype("Full Scale IQ (WAIS-IV)", "", false, ["0", "200", "1"])
    make_phenotype("General Ability Index (WAIS-IV)", "", false, ["0", "200", "1"])
    make_phenotype("Childhood IQ (WISC-IV)", "", false, ["0", "200", "1"])
    make_phenotype("Spearman's g (Raven's Progressive Matrices)", "", false, ["0", "36", "1"])
    make_phenotype("Dyslexia", "", false, ["No", "Yes"])
  end
