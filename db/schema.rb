...
ActiveRecord::Schema.define(version: 20150620011312) do
  ...
  create_table "jawbone_moves", force: :cascade do |t|
    t.integer  "jawbone_profile_id"
  ...
  create_table "jawbone_profiles", force: :cascade do |t|
  ...
  create_table "jawbone_sleeps", force: :cascade do |t|
    t.integer  "jawbone_profile_id"
    t.datetime "date_logged"
    t.integer  "awake"
    t.integer  "duration"
  ...
  create_table "jawbone_weights", force: :cascade do |t|
    t.integer  "jawbone_profile_id"
    t.float    "bmi"
    t.float    "body_fat"
    t.float    "weight"
  ...
  create_table "snps", force: :cascade do |t|
    ...
    t.integer  "number_of_users",    default: 0
    t.datetime "mendeley_updated",   default: '2015-04-29 20:12:04'
    t.datetime "plos_updated",       default: '2015-04-29 20:12:04'
    t.datetime "snpedia_updated",    default: '2015-04-29 20:12:04'
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "user_snps", id: :bigserial, force: :cascade do |t|
  ...
  add_index "user_snps", ["snp_name", "user_id"], name: "index_user_snps_on_user_id_and_snp_name", using: :btree
  add_index "user_snps", ["snp_name"], name: "index_user_snps_on_snp_name", using: :btree
